...
class TilePlugin : FlutterPlugin, MethodChannel.MethodCallHandler {
        ...
        when (call.method) {
            ...
            "updateMode" -> {
                ...
                if (mode != null) {
                    ...
                    com.meowclash.app.GlobalState.currentMode.postValue(mode)
                }
                result.success(null)
            }
            "updateGlobalModeEnabled" -> {
                ...
                com.meowclash.app.GlobalState.globalModeEnabled.postValue(enabled)
                result.success(null)
            }
    ...
    private fun updateTile() {
        ...
        com.meowclash.app.GlobalState.syncStatus()
    }
